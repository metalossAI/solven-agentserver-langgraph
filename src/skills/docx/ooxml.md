...
- **Tracked changes**: Use `<w:del>` and `<w:ins>` tags with `w:author="Solven"` outside `<w:r>` elements
...
### Validation Rules
The validator checks that the document text matches the original after reverting Solven's changes. This means:
...
**Text Insertion:**
```xml
<w:ins w:id="1" w:author="Solven" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
...
**Text Deletion:**
```xml
<w:del w:id="2" w:author="Solven" w:date="2025-07-30T23:05:00Z" w16du:dateUtc="2025-07-31T06:05:00Z">
...
<w:ins w:author="Jane Smith" w:id="16">
  <w:del w:author="Solven" w:id="40">
    <w:r><w:delText>monthly</w:delText></w:r>
  </w:del>
</w:ins>
<w:ins w:author="Solven" w:id="41">
